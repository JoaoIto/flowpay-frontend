...
**Pré-requisitos:** Node.js (versão 18+) instalado. Certifique-se de que o backend (Spring Boot) esteja operante na porta `8080`.
...
2.  **Inicie o servidor de desenvolvimento:**
    ...
    npm run dev
    ```
    *A interface ficará disponível em `http://localhost:5173` (ou outra porta local provida pelo Vite).*
